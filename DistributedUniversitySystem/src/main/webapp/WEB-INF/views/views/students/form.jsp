...
<head>
    ...
    <title>${isEdit ? 'Edit' : 'Add'} Student - University Management System</title>
...
<body>
    ...
    <main class="container">
        <div class="content-wrapper slide-in">
            ...
            <!-- Student Form -->
            <form action="<c:url value='/students/save'/>" method="POST" class="mt-3">
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="email" name="email" value="${student.email}" required
                           placeholder="Enter student's email address" maxlength="100">
                </div>

                <!-- Enrollment Date -->
                <div class="form-group">
                    <label for="enrollmentDate">Enrollment Date <span class="text-danger">*</span></label>
                ...
                <div class="form-group">
                    ...
                    <select id="departmentId" name="departmentId" required>
                        ...
                        <c:forEach var="department" items="${departments}">
                            <option value="${department.id}" <c:if test="${department.id == student.departmentId}">selected</c:if>>
                                ${department.deptName}
                            </option>
                        </c:forEach>
                    </select>
            ...
            <div class="alert alert-info mt-3">
                ...
                <ul>
                    ...
                    <li>Department should be a valid academic department</li>
                </ul>
            </div>
        </div>
    </main>
